...
const Pricing = () => {
  ...
  <div className="w-full mt-4 flex lg:justify-center gap-x-3 overflow-x-auto">
    {/* Card 1 */}
    <div className="relative lg:w-[423.5px] lg:h-[550px] max-lg:min-w-full h-[389px] px-2 rounded-2xl overflow-hidden">
      <img
        src="/image4.png"
        alt="Patients & Families"
        className="w-full h-full object-fill rounded-2xl transform scale-150"
      />
      <div className="absolute bottom-0 w-full text-left text-white px-6 py-6 bg-gradient-to-t from-black/70 via-black/40 to-transparent rounded-b-2xl">
      ...
      {selectedButton === "growPractice" && (
        <div className="w-full bg-white pb-5 pt-10 flex flex-col gap-y-5">
          <MaxWidthWrapper className="overflow-x-auto">
            ...
            {/* REPLACED SECTION (GROW PRACTICE) */}
